...
void tampil_tanggal(tanggal tgl) {
    ...
    **/
    ...
    // YOUR CODE STARTS HERE
    switch(tgl.mm) {
        case 1 : cout << tgl.dd << " Januari " << tgl.yy << endl;

        case 2 : cout << tgl.dd << " Februari " << tgl.yy << endl;

        case 3 : cout << tgl.dd << " Maret " << tgl.yy << endl;

        case 4 : cout << tgl.dd << " April " << tgl.yy << endl;

        case 5 : cout << tgl.dd << " Mei " << tgl.yy << endl;

        case 6 : cout << tgl.dd << " Juni " << tgl.yy << endl;

        case 7 : cout << tgl.dd << " Juli " << tgl.yy << endl;

        case 8 : cout << tgl.dd << " Agustus " << tgl.yy << endl;

        case 9 : cout << tgl.dd << " September " << tgl.yy << endl;

        case 10 : cout << tgl.dd << " Oktober " << tgl.yy << endl;

        case 11 : cout << tgl.dd << " November " << tgl.yy << endl;

        case 12 : cout << tgl.dd << " Desember " << tgl.yy << endl;
    }
